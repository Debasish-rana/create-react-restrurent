...
const ItemList = ({ items }) => {
  ...
  // const nonvegItem = items.filter(
  //   (nonveg) => nonveg.card.info.itemAttribute.vegClassifier === "NONVEG"
  // );
      ...
      <div>
        {items.map((item) => (
          <div
            ...
            className="bg-lime-50 m-4 p-3 shadow-2xl"
          >
            <div className="flex">
              <div>
              ...
              <div>
                ...
                />
                <button
                  className="bg-green-400 text-white p-2 rounded-2xl w-20  ml-6 mt-[-30px]"
